...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-gray-800/30 backdrop-blur-sm rounded-3xl p-4 md:p-6 shadow-sm border border-purple-500/20 cursor-pointer hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-500 group animate-fade-in hover:border-purple-400/40"
    ...
    >
      <div className="flex items-start space-x-3 md:space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-base md:text-lg text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300">
            {title}
          </h3>
