      ...
      default:
        return <div className="relative min-h-screen cosmic-bg overflow-hidden">
            ...
            <div className="relative z-10 pt-20">
              ...
              {/* Footer */}
              <footer className="glass border-t border-border/20 mt-16 mb-20">
                <div className="max-w-6xl mx-auto px-4 py-8">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                    <div>
                      <h3 className="font-semibold text-foreground mb-3 subtle-glow">Product</h3>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li><button onClick={() => openModal('product', 'features')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Features</button></li>
                        <li><button onClick={() => openModal('product', 'updates')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Updates</button></li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold text-foreground mb-3 subtle-glow">Company</h3>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li><button onClick={() => openModal('company', 'about')} className="hover:text-primary transition-colors glass-hover p-1 rounded">About</button></li>
                        <li><button onClick={() => openModal('company', 'careers')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Careers</button></li>
                        <li><button onClick={() => openModal('company', 'contact')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Contact</button></li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold text-foreground mb-3 subtle-glow">Support</h3>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li><button onClick={() => openModal('support', 'help')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Help Center</button></li>
                        <li><button onClick={() => openModal('support', 'docs')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Documentation</button></li>
                        <li><button onClick={() => openModal('support', 'community')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Community</button></li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="font-semibold text-foreground mb-3 subtle-glow">Legal</h3>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                        <li><button onClick={() => openModal('legal', 'privacy')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Privacy Policy</button></li>
                        <li><button onClick={() => openModal('legal', 'terms')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Terms of Service</button></li>
                        <li><button onClick={() => openModal('legal', 'cookies')} className="hover:text-primary transition-colors glass-hover p-1 rounded">Cookie Policy</button></li>
                      </ul>
                    </div>
                  </div>
